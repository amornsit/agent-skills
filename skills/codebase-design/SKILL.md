...
description: Shared vocabulary for designing deep modules. Use when the user wants to design a module's interface, find deepening opportunities, decide where a seam goes, make code more testable or AI-navigable, or when another skill needs the deep-module vocabulary.
---
...
_Adapted from Matt Pocock's "codebase-design" skill (github.com/mattpocock/skills) — MIT © Matt Pocock.
Description tightened to one trigger per branch and the sibling files moved to `references/`.
