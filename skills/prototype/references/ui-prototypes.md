...
[logic-prototypes.md](logic-prototypes.md).
...
way [SKILL.md](../SKILL.md) describes. Fold the winner into the real code and move the rest onto the
...
Reproduced as reference material; renamed from `UI.md` and its links repointed.
