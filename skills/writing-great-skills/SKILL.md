...
3. **External reference** — reference pushed out of `SKILL.md` into a separate file, reached by a **context pointer**, loaded only when the pointer fires. (Spans _disclosed_ reference — a file under `references/`, still part of the skill — through fully **external reference** that lives outside the skill system and any skill can point at.)
...
_Adapted from Matt Pocock's "writing-great-skills" skill (github.com/mattpocock/skills) — MIT © Matt Pocock.
`GLOSSARY.md` moved to `references/glossary.md` with the context pointers repointed, and a body H1 added to match this repo's layout.
