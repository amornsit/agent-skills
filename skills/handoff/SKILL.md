...
*Adapted from Matt Pocock's "handoff" skill (github.com/mattpocock/skills) — MIT © Matt Pocock.
Reproduced verbatim apart from an `# H1` added for this repo's `MD041` rule; nothing was added or
